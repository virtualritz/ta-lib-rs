...
use ta_lib_wrapper::{TA_Integer, TA_Real, TA_RetCode, TA_RSI};

/// Compute RSI(period) on `close_prices`
/// This function returns a tuple containing the list of rsi values and the
/// index of the first close to have an associated rsi value
